...
<header id="header" style="background: url(<?php  header_image(); ?>) no-repeat #<?php get_background_color() ; ?>; ">
	...
	<figure id="logo">
		<a href="<?php echo esc_url(home_url()); ?>" title="<?php bloginfo( 'name' ); ?>">
			<?php
				if((isset($optionsdb['cwp_roby_logo'])) && ($optionsdb['cwp_roby_logo'] != '')) :
					echo '<img src="'.$optionsdb['cwp_roby_logo'].'" alt="'.get_bloginfo( 'name' ).'">';
				else :
				?>
	...
	?>
		<nav id="hmenu">
			<ul>
				<li class="category"><?php _e('Select category','cwp_roby'); ?>
					<div class="menu">
						<ul>
