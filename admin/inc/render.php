<?php
	...
	class cwp_robyRenderView {
		...
		public function __construct(){
			...
			$css_path = cwp_roby_config("admin_template_directory_uri")."/css/";
			$js_path = cwp_roby_config("admin_template_directory_uri")."/js/";
			...
			$this->options =  get_option(cwp_roby_config("menu_slug"));
		...
		public function add_input_text($tabid,$name,$description,$id,$class=''){
			$html = '
				...
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p> <input class="cwp_roby_input " placeholder="'.$name.'" name="'.cwp_roby_config("menu_slug").'['.$id.']" type="text" value="'.$this->options[$id].'"></div>';
		...
		public function add_input_text_disabled($tabid,$name,$description,$id,$class=''){
			$html = '
				...
				<div class="explain">'.$name.'</div><p class="field_description ">'.$description.'</p> <input disabled class="cwp_roby_input " placeholder="'.$name.'" name="'.cwp_roby_config("menu_slug").'['.$id.']" type="text" value="'.$this->options[$id].'"></div>';
		...
		public function get_font_styles(){
				return array(
							'normal'      => __( 'Normal', 'cwp_roby' ),
							'italic'      => __( 'Italic', 'cwp_roby' ),
							'bold'        => __( 'Bold', 'cwp_roby' ),
							'bold italic' => __( 'Bold Italic', 'cwp_roby' )
							);
		}
		...
		public function add_typography($tabid,$name,$description,$id,$class=''){
			...
			$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p> <div class="cwp_roby_typo">

					 <input type="hidden" id="'.$id.'_color" name="'.cwp_roby_config("menu_slug").'['.$id.'][color]" value="'.$this->options[$id]['color'].'"/>
				<input type="text" name=""	class="subo-color-picker" id="'.$id.'_color_selector" value="'.$this->options[$id]['color'].'" />

						<select class="cwp_roby_select cwp_roby_tipsy" original-title="Font family" name="'.cwp_roby_config("menu_slug").'['.$id.'][font]" > ';
					...
					$html .='</select>
						<select class="cwp_roby_select cwp_roby_tipsy" original-title="Font style"  name="'.cwp_roby_config("menu_slug").'['.$id.'][style]" > ';
					...
					$html .='</select>
						<select class="cwp_roby_select cwp_roby_tipsy" original-title="Font size" " name="'.cwp_roby_config("menu_slug").'['.$id.'][size]" > ';
					foreach($sizes as $v){
		...
		public function get_bg_repeat(){
			...
			return array(
					'no-repeat' => __('No Repeat', 'cwp_roby'),
					'repeat-x'  => __('Repeat Horizontally', 'cwp_roby'),
					'repeat-y'  => __('Repeat Vertically', 'cwp_roby'),
					'repeat'    => __('Repeat All', 'cwp_roby'),
					);
		}
		public function get_bg_position(){
			return array(
						'top left'      => __('Top Left', 'cwp_roby'),
						'top center'    => __('Top Center', 'cwp_roby'),
						'top right'     => __('Top Right', 'cwp_roby'),
						'center left'   => __('Middle Left', 'cwp_roby'),
						'center center' => __('Middle Center', 'cwp_roby'),
						'center right'  => __('Middle Right', 'cwp_roby'),
						'bottom left'   => __('Bottom Left', 'cwp_roby'),
						'bottom center' => __('Bottom Center', 'cwp_roby'),
						'bottom right'  => __('Bottom Right', 'cwp_roby')
						);
		}
		...
		public function add_background($tabid,$name,$description,$id,$class=''){
			...
			$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p><div class="cwp_roby_background">
					<div class="cwp_roby_bgstyle">
						<div class="cwp_roby_bgimage">
						<input type="hidden" id="'.$id.'" name="'.cwp_roby_config("menu_slug").'['.$id.'][bgimage]" value="'.$this->options[$id]['bgimage'].'"/>
				...
				<a id="'.$id.'_buttonclear" class="clear-image button"  >Clear image</a>
						...
						<div class="cwp_roby_bgcolor">
						<input type="hidden" id="'.$id.'_color" name="'.cwp_roby_config("menu_slug").'['.$id.'][bgcolor]" value="'.$this->options[$id]['bgcolor'].'"/> <br/>
				<input type="text" name=""	class="subo-color-picker" id="'.$id.'_color_selector" value="'.$this->options[$id]['bgcolor'].'" />
						</div><div class="clear"></div>
					</div>
					<div class="cwp_roby_bgformat">

						<select class="cwp_roby_select cwp_roby_tipsy" original-title="Background repeat"  name="'.cwp_roby_config("menu_slug").'['.$id.'][bgrepeat]" > ';
					...
					$html .='</select>
						<select class="cwp_roby_select cwp_roby_tipsy" original-title="Background position"  name="'.cwp_roby_config("menu_slug").'['.$id.'][bgposition]" > ';
					...
					$html .='</select>
						<select class="cwp_roby_select cwp_roby_tipsy" original-title="Background attachament"  name="'.cwp_roby_config("menu_slug").'['.$id.'][bgattachment]" > ';
		...
		public function add_textarea($tabid,$name,$description,$id,$class=''){
			...
			$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p> <textarea class="cwp_roby_textarea " placeholder="'.$name.'" name="'.cwp_roby_config("menu_slug").'['.$id.']"    >'.$this->options[$id].'</textarea></div>';
		...
		public function add_textarea_disabled($tabid,$name,$description,$id,$class=''){
			...
			$html = '
				<div class="controls '.$class.' field_disabled">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p> <textarea disabled class="cwp_roby_textarea " placeholder="'.$name.'" name="'.cwp_roby_config("menu_slug").'['.$id.']"    >'.$this->options[$id].'</textarea></div>';
		...
		public function add_editor($tabid,$name,$description,$id,$class=''){
			...
			wp_editor($this->options[$id], cwp_roby_config("menu_slug").'['.$id.']');
		...
		public function add_input_number($tabid,$name, $description, $id, $min = false, $max = false, $step = false, $class = ""){
			$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>  <input placeholder="'.$name.'" type="number"  class="cwp_roby_input" value="'.$this->options[$id].'" name="'.cwp_roby_config("menu_slug").'['.$id.']"
					'.($min === false ? '' : ' min = "'.$min.'" ').'
					'.($max === false ? '' : ' max = "'.$max.'" ').'
		...
		public function add_select($tabid,$name,$description,$id,$options,$class=""){
				...
				$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>   <select class=" cwp_roby_select" name="'.cwp_roby_config("menu_slug").'['.$id.']" > ';
		...
		public function add_multiselect($tabid,$name,$description,$id,$options,$class=""){
				...
				$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>   <select   name="'.cwp_roby_config("menu_slug").'['.$id.'][]" class="cwp_roby_multiselect" multiple > ';
					foreach($options as $k=>$v){
		...
		public function add_checkbox($tabid,$name,$description,$id,$options,$class=""){
				...
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>  ';
					foreach($options as $k=>$v){
						...
						$html.="<label class='cwp_roby_label'><input class='cwp_roby_checkbox' type=\"checkbox\" name='".cwp_roby_config("menu_slug")."[".$id."][]' value='".$k."' ".(in_array($k,$this->options[$id]) ? 'checked' : '')." >".$v."</label>";
					}
		...
		public function add_radio($tabid,$name,$description,$id,$options,$class=""){
				...
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>  ';
					foreach($options as $k=>$v){
						...
						$html.="<label class='cwp_roby_label'><input class='cwp_roby_radio' type=\"radio\" name='".cwp_roby_config("menu_slug")."[".$id."]' value='".$k."' ".($this->options[$id] == $k ? 'checked' : '').">".$v."</label>";
					}
		...
		$html = '
				<div class="controls '.$class.'">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>
				<input type="hidden" id="'.$id.'" name="'.cwp_roby_config("menu_slug").'['.$id.']" value="'.$this->options[$id].'"/>
		...
		$html = '
				<div class="controls '.$class.' ">
				<div class="explain">'.$name.'</div><p class="field_description">'.$description.'</p>
				<input type="hidden" id="'.$id.'_color" name="'.cwp_roby_config("menu_slug").'['.$id.']" value="'.$this->options[$id].'"/> </br>
