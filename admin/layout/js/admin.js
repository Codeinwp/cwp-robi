...
jQuery("document").ready(function() {
	...
	jQuery("#cwp_roby_container").fadeIn(200);
  ...
  jQuery("#cwp_roby_nav li a").live("click",function(){
  ...
  jQuery(".cwp_roby_save").live("click",function(){
				var b =  jQuery("#cwp_roby_form").serialize();
				jQuery(".cwp_roby_save").addClass("button-primary-disabled");
				jQuery(".cwp_roby_reset").addClass("button-disabled");
				jQuery(".spinner").show();
                jQuery.post( 'options.php', b ).error(
                    function() {
						jQuery(".spinner").hide();
						jQuery(".cwp_roby_reset").removeClass("button-disabled");
						jQuery(".cwp_roby_save").removeClass("button-primary-disabled");
                    }).success( function() {
						jQuery(".spinner").hide();
						jQuery(".cwp_roby_reset").removeClass("button-disabled");
						jQuery(".cwp_roby_save").removeClass("button-primary-disabled");
  ...
  jQuery(".cwp_roby_reset").live("click",function(){
				jQuery(".cwp_roby_reset").addClass("button-disabled");
				jQuery(".cwp_roby_save").addClass("button-primary-disabled");
				jQuery(".spinner ").show();
			  jQuery.post( ajaxurl,{action:"cwp_roby_load_defaults"} ).error(
                    function() {
						jQuery(".spinner").hide();
						jQuery(".cwp_roby_reset").removeClass("button-disabled");
						jQuery(".cwp_roby_save").removeClass("button-primary-disabled");
